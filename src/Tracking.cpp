...
bool Tracking::TrackLocalMap()
{
    ...
    // ADD this codes (2023/10/30)///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

//    const cv::Mat T_wc_current = cv::Mat::eye(4,4,mCurrentFrame -> mTcw.type());
//    (mCurrentFrame -> GetRotationInverse()).copyTo(T_wc_current.rowRange(0,3).colRange(0,3));
//    (mCurrentFrame -> GetCameraCenter()).copyTo(T_wc_current.rowRange(0,3).col(3));

//    const cv::Mat T_wc_lastKF = mpLastKeyFrame -> GetPoseInverse();  

//    cout << "current mTwc : " << T_wc_current << endl;
//    cout << "lastKF mTwc : " << T_wc_lastKF << endl;

//    const Eigen::Matrix4d eT_wc_current = Converter::toMatrix4d(T_wc_current);
//    const Eigen::Matrix4d eT_wc_lastKF = Converter::toMatrix4d(T_wc_lastKF);

//    Eigen::Matrix4d T_SC_current;
//    Eigen::Matrix4d T_SC_lastKF;
//    T_SC_current = mpCC -> mT_SC;
//    T_SC_lastKF = mpLastKeyFrame -> mT_SC;

//    cout << "T_SC_current : " << T_SC_current << endl;
//    cout << "T_SC_lastKF : " << T_SC_lastKF << endl;

//    cout << "eT_wc_lastKF" << eT_wc_lastKF << endl;

//    const Eigen::Matrix4d Tws_current = eT_wc_current * T_SC_current.inverse();
//    const Eigen::Matrix4d Tws_lastKF = eT_wc_lastKF * T_SC_current.inverse();
//    const Eigen::Matrix4d Tws_lastKF = eT_wc_lastKF * T_SC_lastKF.inverse();    

//    const Eigen::Matrix4d Tws_current = eT_wc_current * T_SC.inverse();
//    const Eigen::Matrix4d Tws_lastKF = eT_wc_lastKF * T_SC.inverse();

//    cout << "abs X: " << abs(Tws_current(0,3) - Tws_lastKF(0,3)) << endl;
//    cout << "abs Y: " << abs(Tws_current(1,3) - Tws_lastKF(1,3)) << endl;
//    cout << "abs Z: " << abs(Tws_current(2,3) - Tws_lastKF(2,3)) << endl;

//    cout << "abs X: " << abs(eT_wc_current(0,3) - eT_wc_lastKF(0,3)) << endl;
//    cout << "abs Y: " << abs(eT_wc_current(1,3) - eT_wc_lastKF(1,3)) << endl;
//    cout << "abs Z: " << abs(eT_wc_current(2,3) - eT_wc_lastKF(2,3)) << endl;

//    cout << "Tws_lastKF" << Tws_lastKF << endl;
//    cout << "Tws_lastKF(0,3) : " << Tws_lastKF(0,3) << endl;
//    cout << "Tws_current(0,3) : " << Tws_current(0,3) << endl;

//    if (abs(Tws_current(0,3) - Tws_lastKF(0,3)) > max_abs_X) {
//        max_abs_X = abs(Tws_current(0,3) - Tws_lastKF(0,3));
//        cout << "max_abs_X : " << max_abs_X << endl;
//    }
//    if (abs(Tws_current(1,3) - Tws_lastKF(1,3)) > max_abs_Y) {
//        max_abs_Y = abs(Tws_current(1,3) - Tws_lastKF(1,3));
//        cout << "max_abs_Y : " << max_abs_Y << endl;
//    }
//    if (abs(Tws_current(2,3) - Tws_lastKF(2,3)) > max_abs_Z) {
//        max_abs_Z = abs(Tws_current(2,3) - Tws_lastKF(2,3));
//        cout << "max_abs_Z : " << max_abs_Z << endl;
//    }

//    if(abs(Tws_current(0,3) - Tws_lastKF(0,3)) > 0.2*denied_count || abs(Tws_current(1,3) - Tws_lastKF(1,3)) > 0.2*denied_count || abs(Tws_current(2,3) - Tws_lastKF(2,3)) > 0.2*denied_count)
//    {
//        cout << "denied by added codes" << endl;
//        denied_count = denied_count + 2;
//        cout << "denied count : " << denied_count << endl;
//        return false;
//    }
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
void Tracking::CreateNewKeyFrame()
{
    ...
    //float v1_x = Tws_current(0,3) - Tws_lastKF(0,3);
    //float v1_y = Tws_current(1,3) - Tws_lastKF(1,3);
    //float v1_z = Tws_current(2,3) - Tws_lastKF(2,3);
    //float v2_x = X_diff;
    //float v2_y = Y_diff;
    //float v2_z = Z_diff;

    //X_diff = Tws_current(0,3) - Tws_lastKF(0,3);
    //Y_diff = Tws_current(1,3) - Tws_lastKF(1,3);
    //Z_diff = Tws_current(2,3) - Tws_lastKF(2,3);
    ...
    if (count > 1) {
        ...
        // for debug
        //cout << "degree (Tracking) : " << pKF->xy_deg << ", " << pKF->yz_deg << ", " << pKF->zx_deg << endl;
        //cout << "Tws_current : " << Tws_current(0,3) << ", " << Tws_current(1,3) << ", " << Tws_current(2,3) << endl;
    }
    */
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
