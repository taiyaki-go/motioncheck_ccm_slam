...
public:
    ...
    KeyFrame(ccmslam_msgs::KF* pMsg, vocptr pVoc, mapptr pMap, dbptr pKFDB, commptr pComm, eSystemState SysState,
                       size_t UniqueId = defid, g2o::Sim3 mg2oS_wcurmap_wclientmap = g2o::Sim3(), float tracking_x = 0, float tracking_y = 0, float tracking_z = 0); //constructor for message input // last-modified (2023/12/13)
    ...
    cv::Mat GetPose_GBABef();
    cv::Mat GetPoseInverse_GBABef();
    //////////////////////////////////////////////////////////////////////////////
    ...
    // add this code (2023/12/8) //////////////////////////////////////////////////
    cv::Mat GetTranslation_GBABef();
    cv::Mat GetTranslation_GBAAft();
    ///////////////////////////////////////////////////////////////////////////////
...
// add this code (2023/11/11) //////////////////////////////////////////////////////
    ...
    cv::Mat Tcw_current;
    cv::Mat Tcw_new;
    bool isLoopClosing = false;
    bool set_original = false;
    bool update_current = false;
    //////////////////////////////////////////////////////////////////////////////

    // add this code (2023/12/23) ////////////////////////////////////////////////
    int doubt_for_MV = 0;
